...
@section('title', 'Edit data kos saya')
@section('headertitle', 'Edit data kos saya')
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" action="{{route('pemilik.update', $data->id)}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method("PUT")
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            <div class="card" style="text-align:center">
                                                <div class="card-content">
                                                    ...
                                                    @else    
                                                        <img class="card-img-top img-fluid" src="{{asset('storage/galeri_kos/'. $data->foto_bgnan_tampak_depan)}}" alt="Card image cap" style="width: 50%" id="file-1" />
                                                    @endif
                                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <div class="card" style="text-align:center">
                                                <div class="card-content">
                                                    ...
                                                    @else
                                                        <img class="card-img-top img-fluid" src="{{asset('storage/galeri_kos/'. $data->foto_bgnan_dalam)}}" alt="Card image cap" style="width: 50%" id="file-2" />
                                                    @endif
                                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <div class="card" style="text-align:center">
                                                <div class="card-content">
                                                    ...
                                                    @else
                                                        <img class="card-img-top img-fluid" src="{{asset('storage/galeri_kos/'. $data->foto_bgnan_dari_jalan)}}" alt="Card image cap" style="width: 50%" id="file-3" />
                                                    @endif
                                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <div class="card" style="text-align:center">
                                                <div class="card-content">
                                                    ...
                                                    @else
                                                        <img class="card-img-top img-fluid" src="{{asset('storage/galeri_kos/'. $data->foto_km_depan)}}" alt="Card image cap" style="width: 50%" id="file-4" />
                                                    @endif
                                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <div class="card" style="text-align:center">
                                                <div class="card-content">
                                                    ...
                                                    @else
                                                        <img class="card-img-top img-fluid" src="{{asset('storage/galeri_kos/'. $data->foto_km_dalam)}}" alt="Card image cap" style="width: 50%" id="file-5" />
                                                    @endif
                                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <div class="card" style="text-align:center">
                                                <div class="card-content">
                                                    ...
                                                    @else
                                                        <img class="card-img-top img-fluid" src="{{asset('storage/galeri_kos/'. $data->foto_km_mandi)}}" alt="Card image cap" style="width: 50%" id="file-6" />
                                                    @endif
                                                    <div class="card-body">
                                    ...
                                    <div class="col-md-6 col-12">
                                        ...
                                        <div class="form-group d-flex">
                                            <input type="number" id="p_kamar" class="form-control" name="p_kamar" placeholder="Panjang" value="{{$data->p_kamar}}" >
                                            <label for="ukuran_kamar" class="mt-1 mx-3"><i class="bi bi-x"></i></i></label>
                                            <input type="number" id="l_kamar" class="form-control" name="l_kamar" placeholder="Lebar"  value="{{$data->l_kamar}}">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
