...
class KosDataController extends Controller
{
    /**
    ...
    {
        $data = KosData::all();
        return view('admin.datakos.index', compact('data'));
    }
    ...
    {
        return view('admin.datakos.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('foto_bgnan_tampak_depan', 'foto_bgnan_dalam', 'foto_bgnan_dari_jalan', 'foto_km_depan', 'foto_km_dalam', 'foto_km_mandi') == null) {
            ...
            return to_route('data-kos.index', compact('create'))->with('success', 'Data berhasil disimpan');
        }
    ...
    public function show($id)
    {
        ...
        return view('admin.datakos.show', compact('data'));
    }
    ...
    {
        $data = KosData::where('id', $id)->first();
        return view('admin.datakos.edit', compact('data'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->hasFile('foto_bgnan_tampak_depan', 'foto_bgnan_dalam', 'foto_bgnan_dari_jalan', 'foto_km_depan', 'foto_km_dalam', 'foto_km_mandi')) {
            $request->validate([
                'foto_bgnan_tampak_depan' => 'mimes:jpg,png,jpeg|image|max:2400|nullable',
                'foto_bgnan_dalam' => 'mimes:jpg,png,jpeg|image|max:2400|nullable',
                'foto_bgnan_dari_jalan' => 'mimes:jpg,png,jpeg|image|max:2400|nullable',
            ...
            $image_data = KosData::where('id', $id)->first();
            File::delete(public_path('storage/galeri_kos/' . $image_data->foto_bgnan_tampak_depan));
            File::delete(public_path('storage/galeri_kos/' . $image_data->foto_bgnan_dari_jalan));
            File::delete(public_path('storage/galeri_kos/' . $image_data->foto_bgnan_dalam));
            File::delete(public_path('storage/galeri_kos/' . $image_data->foto_km_depan));
            File::delete(public_path('storage/galeri_kos/' . $image_data->foto_km_dalam));
            File::delete(public_path('storage/galeri_kos/' . $image_data->foto_km_mandi));
        ...
        KosData::where('id', $id)->update($data);
        return to_route('data-kos.index')->with('success', 'Data berhasil di ubah');
    }
    ...
    public function destroy($id)
    {
        $data = KosData::where('id', $id)->first();
        // $file = [
        //     $data->foto_bgnan_tampak_depan,
        //     $data->foto_bgnan_dari_jalan,
        //     $data->foto_bgnan_dalam,
        //     $data->foto_km_depan,
        //     $data->foto_km_dalam,
        //     $data->foto_km_mandi
        // ];
        File::delete(public_path('storage/galeri_kos/' . $data->foto_bgnan_tampak_depan));
        File::delete(public_path('storage/galeri_kos/' . $data->foto_bgnan_dari_jalan));
        File::delete(public_path('storage/galeri_kos/' . $data->foto_bgnan_dalam));
        File::delete(public_path('storage/galeri_kos/' . $data->foto_km_depan));
        File::delete(public_path('storage/galeri_kos/' . $data->foto_km_dalam));
        File::delete(public_path('storage/galeri_kos/' . $data->foto_km_mandi));

        KosData::where('id', $id)->delete();
        return to_route('data-kos.index')->with('success', 'Data berhasil di hapus');
    }
}
